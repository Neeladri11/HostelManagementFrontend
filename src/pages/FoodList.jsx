...
//         `https://yoodahostel.herokuapp.com/api/foods?page=${count}`,
//         {
//           headers: {
...
//             {edit && (
//               <div
//                 className={`my-10 top-16 w-3/6 left-90 bg-white shadow-lg py-10 px-20 absolute`}
//               >
...
//         >
//           <p className="text-center text-lg font-medium py-6">
